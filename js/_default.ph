...
<html>
    <head>
        <title>Bun Venit la <? print $host; ?>! Hostinger - Găzduire Gratuită cu  PHP şi MySQL.</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.ro/"><img src="http://www.hostinger.ro/images/logo-ro.png" alt="Găzduire Web" /></a>
                </div>
                <div class="content">
                    <h1>Contul tău a fost creat!</h1>
                    <p>Contul <b><? print $host; ?></b> a fost adăugat şi configurat cu succes pe server! Te rog să ştergi fişierul <b>default.php</b> din folderul <b>public_html</b> şi apoi să-ţi uploadezi situl folosind un Manager de Fişiere sau un client FTP.</p>
                    <p>Mai jos găseşti o listă cu fișierele din folderul public_html:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.ro/gazduire-web" target="_blank">Găzduire Web</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.ro/gazduire-gratuita" target="_blank">Găzduire Web Gratuită</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.ro/forum" target="_blank">Forum Suport</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.ro/" target="_blank">Acces Portal Clienţi </a>
                </div>
                <div class="copyright">Hostinger România &copy; <? print date('Y'); ?>. Toate drepturile rezervate.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.ro"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
